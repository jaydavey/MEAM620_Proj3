classdef QuadPlot < handle
    ...
    methods
        ...
        function Q = QuadPlot(qn, state, wingspan, height, color, max_iter, h_3d)
            ...
            Q.h_3d = h_3d;
            hold(Q.h_3d, 'on')
            Q.h_pos_hist = plot3(Q.h_3d, Q.state(1), Q.state(2), Q.state(3), 'r.', 'MarkerSize', 0.5);
            Q.h_pos_des_hist = plot3(Q.h_3d, Q.des_state(1), Q.des_state(2), Q.des_state(3), 'b.', 'MarkerSize', 0.5);
            Q.h_m13 = plot3(Q.h_3d, ...
                Q.motor(1,[1 3]), ...
                Q.motor(2,[1 3]), ...
                Q.motor(3,[1 3]), ...
                '-ko', 'MarkerFaceColor', Q.color, 'MarkerSize', 7,'LineWidth', 2);
            ...
            Q.h_qn = text(...
                ...
                Q.motor(3,5) + Q.text_dist, num2str(qn), 'Color', 'r', 'FontSize', 12, 'FontWeight', 'Bold');
            hold(Q.h_3d, 'off')
        end
